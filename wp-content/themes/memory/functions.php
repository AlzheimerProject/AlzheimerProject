...
function memory_content_width() {
	$GLOBALS['content_width'] = apply_filters( 'memory_content_width', 640 );
}
...
function memory_scripts() {
	wp_enqueue_style( 'memory-style', get_stylesheet_uri(), array(), _S_VERSION );
	wp_style_add_data( 'memory-style', 'rtl', 'replace' );

	wp_enqueue_script( 'memory-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
